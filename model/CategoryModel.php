...
class CategoryModel {
    ...
    private static $create_table_fields = array(
        "required" => array("type_id", "title", "slug"),
        "not_required" => array("id", "user_id", "icon", "is_delete")
    );
    private static $get_args = array(
        "page" => array("limit", "offset"),
        "sort" => array("orderby", "order"),
        "fields" => array("id", "user_id", "type_id", "title", "slug", "icon", "is_delete")
    );
    private $db;
